...
<section class="trainer-book-container">
    ...
    <div class="booking-count">
        <p>담당 회원 상담 예약: <strong><?= $member_book_count ?></strong> 건</p>
    </div>

    <!-- 비회원 상담 대기 리스트 -->
    <div class="unlogin-book-waiting" onclick="location.href='unlogin_book_list.php'" style="cursor: pointer;">
        <h2>비회원 상담 대기 리스트</h2>
        <p class="waiting-count"><strong><?= $unlogin_book_count ?></strong> 건</p>
        <p class="waiting-desc">클릭하여 대기 중인 비회원 예약을 확인하세요</p>
    </div>

    <!-- 버튼 박스 -->
    <div class="trainer-book-button-box">
        <button class="btn-book btn-secondary" onclick="location.href='trainer_book_list.php'">예약 관리</button>
